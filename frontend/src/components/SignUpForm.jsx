      ...
      <div>
        <div className="form-container">
          <form autoComplete="off" onSubmit={this.handleSubmit}>
            <label>Name</label>
            <input type="text" name="name" value={this.state.name} placeholder="your name" onChange={this.handleChange} required />
            <label>Email</label>
            ...
            <label>Confirm</label>
            <input type="password" name="confirm" value={this.state.confirm} placeholder="again, thy password" onChange={this.handleChange} required />
